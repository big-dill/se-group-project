    ...
    private void initialiseObjectColumnMap() {
        ...
        ObjectTableColumn<ExampleTeacher> ageColumn =
            new ObjectTableColumnBuilder<ExampleTeacher>()
                ...
                .setRowElementSetter((teacher, value) -> teacher.setAge((Integer) value))
                .build();
        ...
        ObjectTableColumn<ExampleTeacher> qualificationsColumn =
            new ObjectTableColumnBuilder<ExampleTeacher>()
                .setTitle("Qualifications Held")
                .setClass(List.class)
                .setRowElementGetter((teacher) -> teacher.getQualifications())
                .setRowElementSetter((teacher, value) -> teacher.setQualifications(
                    (List<ExampleQualification>) value))
                    // This is where we add the list selector created above
                .setCellEditor(qualificationListSelector)
                .build();
