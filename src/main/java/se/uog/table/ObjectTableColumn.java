...
public class ObjectTableColumn<E> {
     ...
     * @param columnClass      The class type the column deals with. This allows
     *                         automatic setting of renderers and editors, for
     *                         example, checkboxes for Booleans.
     * @param rowElementSetter A function which calls the appropriate setter for the
     *                         column. The function is passed the element refererred
     *                         to by the row (E) and the value from the
     *                         TableCellEditor (Object). This should be casted
     *                         appropriately.
     * @param rowElementGetter A function which calls the appropriate getter for the
     *                         column. The function is passed the element refererred
     *                         to by the row (E) and is expected to return an
     *                         Object.
     * @param isColumnEditable If this is true, the column cells can be edited by
     *                         the user using the column's TableCellEditor.
     * @param columnCellEditor The TableCellEditor used to edit cells in this
     *                         column. If this is null, swing will set the default
    ...
    /**
     * Returns the getter used by the TableModel to tell it how to get the
